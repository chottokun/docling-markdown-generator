...
async def test_create_output_dir_file_exists_error(tmp_path, monkeypatch):
    ...
    # In case uuid is used instead of os.urandom in some environments:
    try:
        import uuid
    ...
    # Pre-create files for BOTH possible paths to support either implementation seamlessly
    file_path_urandom = tmp_path / b"12345678".hex()
    file_path_urandom.write_text("not a directory")

    file_path_uuid = tmp_path / "12345678-1234-5678-1234-567812345678"
    file_path_uuid.write_text("not a directory")
